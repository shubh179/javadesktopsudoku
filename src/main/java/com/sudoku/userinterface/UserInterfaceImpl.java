...
import com.sudoku.userinterface.IUserInterfaceContract.EventListener;
...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private void drawTextFields(Group root) {
        ...
        for (int xIndex = 0; xIndex < 9; xIndex++) {
            for (int yIndex = 0; yIndex < 9; yIndex++) {
                ...
                textFieldCoordinates.put(new Coordinate(xIndex, yIndex), tile);
    ...
    private void drawTitle(Group root) {
        Text title = new Text(260, 40, SUDOKU);
    ...
    public void showDialog(String message) {
        ...
        if (dialog.getResult() == ButtonType.OK) listener.onDialogClicked();
    }
